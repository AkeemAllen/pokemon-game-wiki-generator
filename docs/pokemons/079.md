...
(Slowbro) Level 37 or level up with shellder in the party, (Slowking) Level up at day with king's rock
...
| 1     | Curse        | -     | -        | 10 | ![unknown](../img/types/unknown.png) | ![status](../img/types/status.png)     |
